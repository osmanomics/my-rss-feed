...
CATEGORY_MAPPING = {
    ...
    # Catch-all for anything with no regulatory impact on AbbVie
...
AbbVie's portfolio consists of prescription pharmaceuticals and biologics (small molecules, monoclonal antibodies,
immunology drugs, oncology drugs, neuroscience drugs, aesthetics, and eye care products). AbbVie does NOT
manufacture veterinary products, food/dietary supplements, vitamins, natural health products (NHP),
narcotics for abuse treatment, nicotine products, or cosmetics.

Your task: Analyze the regulatory update below and determine if it has any direct regulatory affairs impact on AbbVie.

CRITICAL RULE: If the update does NOT affect AbbVie from a regulatory affairs standpoint — for example because it
pertains to a product type, therapeutic area, or regulatory pathway that is entirely outside AbbVie's scope —
you MUST assign the category "Not Applicable". Do NOT force-fit it into another category.

If it DOES affect AbbVie, assign EXACTLY ONE of these categories: {ALLOWED_CATEGORIES}
